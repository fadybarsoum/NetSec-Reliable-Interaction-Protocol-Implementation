...
sys.path.append("/home/fady/Documents/GitRepo/en600424lab2/src/rip/")
...
from apps.samples import passthru
...
if __name__=="__main__":
    ...
    if mode.lower() == "server":
        ...
        echoServerEndpoint = GateServerEndpoint.CreateFromConfig(reactor, 13370, gateKey, networkStack=RIPProtocol)
        ...
        echoClientEndpoint = GateClientEndpoint.CreateFromConfig(reactor, echoServerAddr, 13370, gateKey, networkStack=RIPProtocol)
